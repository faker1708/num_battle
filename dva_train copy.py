    ...
    def simulate(self,mode,num_episode):
        ...
        for i in range(num_episode):
            ...
            while(1):   # 游戏中
                ...
                transition_dict_list[flag]['visions'].append(vision)
                transition_dict_list[flag]['actions'].append(action)
                transition_dict_list[flag]['next_visions'].append(next_vision)
            ...
            if(load):
                ...
                for _ in range(0,2):
                    ...
                    for j in range(0,agent_quantity_per_flag):
                        ax = ppo.ppo(n_visions=n_visions,  # 状态数
